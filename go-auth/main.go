...
func GetDatabase() *gorm.DB {
	//databasename := "root:admin"
	database := "mysql"
	//databasepassword := "admin"
	//databaseurl := "mysql://mysql:" + databasepassword + "@localhost/" + databasename + "?sslmode=disable"

	connection, err := gorm.Open(database, "root:admin@/test?charset=utf8&parseTime=True&loc=Local")
	if err != nil {
